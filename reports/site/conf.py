...
BLOG_AUTHOR = "Joshua Jay Herman"  # (translatable)
BLOG_TITLE = "Saati: Waifu as a service"  # (translatable)
...
BLOG_EMAIL = "zitterbewegung@gmail.com"
BLOG_DESCRIPTION = "Saati is an waifu as a service. Or in other words an open source virtual dating / idol simulator."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
		...
		("https://github.com/zitterbewegung/Saati", "fa fa-github"),
